...
class CoarseGrained:
    ...
    # @MAP
    BB_mapping = nsplit("P OP1 OP2 O5' H5T H3T O1P O2P O3'", 
                        "C5' 1H5' 2H5' C4' H4' O4'", 
                        "C1' H1' C2' 1H2' O2' C3' H3'")
    mapping = {
            "A":  BB_mapping + nsplit(
                            "N9 C8 H8",
                            "N3 C4",
...
class elnedyn30nucleic():
    ...
    def __init__(self):
        ...
        # RNA BACKBONE PARAMETERS
        self.rna_bb = {
            'atom'  : spl("Q1 SC2r SN1dr"),     # Have a look at BB3 bead type
            'bond'  : [(1,  0.363, 0),          
                       (1,  0.202, 0),    #8  , 0.202 50000    
                       (1,  0.354, 0)],         
            'angle' : [(1,  117.0, 0),      #2, 117.0, 140       
                       (1,   95.0, 0),           
                       (1,   93.0,  0)],           
            'dih'   : [(2,    0.0, 0),
                       (2,    0.0, 0),
