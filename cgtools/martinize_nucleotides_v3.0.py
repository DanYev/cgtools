...
class elnedyn30nucleic():
    ...
    def __init__(self):
        ...
        self.rna_bb = {
            'atom'  : spl("Q1n C1er N1"),     # Have a look at BB3 bead type
            'bond'  : [(1,  0.348, 25000),          
                       (1,  0.382, 12000),
                       (1,  0.240, 25000),
            ...
            'angle' : [(10,  114.0, 40),      #2, 117.0, 140       
                       (10,  118.0, 50)],           
            'dih'   : [(3,   10.0,  -10.0, 25.0, 5.0, -25.0, 0.0), # (3,   15.0,  -15.0, 25.0, 7.0, -25.0, 0.0)
                       (1,   -10.0,  20, 1),], # (3,   15.0,  -15.0, 30.0, 8.0, -30.0, 0.0)
            'excl'  : [(), (), ()],
            'pair'  : [],
        }
        # RNA BACKBONE CONNECTIVITY
