...
class martini30rna(NucleicForceField):
    ...
    def __init__(self, directory='regular', mol=rna_system, version='new'):
        ...
        self.bb_bonds = [
                    ...
                    [(1, 0), (1,  0.378, 12000), ('BB2-nBB1')],
                    [(2, 0), (1,  0.412, 12000), ('BB3-nBB1')]
                    ]
        self.bb_angles = [
                    [(0, 1, 0), (10,  110.0, 50), ('BB1-BB2-nBB1')],          
                    [(1, 0, 1), (10,  121.0, 180), ('BB2-nBB1-nBB2')],
                    [(0, 1, 2), (10,  143.0, 300), ('BB1-BB2-BB3')]
                    ]
        self.bb_dihs = [
                    [(0, 1, 0, 1), (1,    0.0, 25.0, 1), ('BB1-BB2-nBB1-nBB2')],          
                    [(-2, 0, 1, 0), (1,    0.0, 25.0, 1), ('pBB2-BB1-BB2-nBB1')],
                    [(-2, 0, 1, 2), (1, -112.0, 15.0, 1), ('pBB2-BB1-BB2-BB3')]
                    ]
        self.bb_cons = []
        self.bb_excls = [
                    [(0, 2), (), ('BB1-BB3')], 
