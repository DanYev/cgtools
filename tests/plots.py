...
import pandas as pd
import sys
from cgtools.plotting import plot_mean_sem, plot_heatmaps, HeatMap
from cgtools.pdbtools import update_bfactors
from cgtools.system import CGSystem
...
def heatmap(metric='dci'):
    ...
    for sysname in sysnames:
        ...
        plot_heatmaps(files, figpath, vmin=0.0, vmax=2.0, cmap='bwr', 
