...
sysnames = ['test'] # 4zt0 8aw3 100bpRNA rna_test
...
def submit_md_script():
    for sysname in sysnames:
        ...
        for runname in runs:
            ...
            # sbatch(script, 'run_all.py', 'md', sysdir, sysname, runname, N=1, n=1, c=6, t='00-01:00:00', gres='gpu:1', mem='4G', qos='grp_sozkan', partition='general')
